...
#include "gmap.cpp" // error indéfinies
...
void question1b()
{
    ...
    GMap::idlist_t vlist;
    for (int i = 0; i < 10; ++i)
        vlist.push_back(mgmap.add_dart());
...
int main(int argc, char **argv)
{
    ...
    CHECK("1a", question1a)
    else CHECK("1b", question1b) else CHECK("1c", question1c) else CHECK("1d", question1d) else CHECK("2", question2) else CHECK("3", question3) else CHECK("4a", question4a) else CHECK("4b", question4b) else CHECK("5", question5) else CHECK("6a", question6a) else CHECK("6b", question6b) else CHECK("7", question7) else
    {
